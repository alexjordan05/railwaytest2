                ...
                <div class="d-flex flex-lg-row flex-column">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="#">Beef Steak Sauce</a>
                          <a class="dropdown-item" href="#">Salmon Zucchini</a>
                        </div>
                    </li>
                </div>
            </ul>
	...
	<div class="row d-flex align-items-center">
	    ...
	    <div class="col-lg-6 hero-right">
	    	<div class="owl-carousel owl-theme hero-carousel">
			    <div class="item">
			    	<img class="img-fluid" src="{{asset('img/hero-1.jpg')}}" alt="">
			    </div>
			    <div class="item">
			    	<img class="img-fluid" src="{{asset('img/hero-2.jpg')}}" alt="">
			    </div>
			    <div class="item">
			    	<img class="img-fluid" src="{{asset('img/hero-3.jpg')}}" alt="">
			    </div>
			</div>
	    </div>
	</div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <a href="#" class="thumb-menu">
                                    <img class="img-fluid img-cover" src="{{asset('img/hero-1.jpg')}}" />
        ...
        <div class="section-content">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="{{asset('img/steak.jpg')}}" alt="" class="img-fluid shadow w-100">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="{{asset('img/salmon-zucchini.jpg')}}" alt="" class="img-fluid shadow w-100">
                </div>
                ...
                <div class="col-lg-4 menu-wrap">
                    ...
                    <div class="menus d-flex align-items-center">
                        <div class="menu-img rounded-circle">
                            <img class="img-fluid" src="{{asset('img/breakfast-1.jpg')}}" alt="">
                        </div>
                        <div class="text-wrap">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('img/chef-1.jpg')}}" alt="">
                        <div class="team-desc">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('img/chef-2.jpg')}}" alt="">
                        <div class="team-desc">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('img/chef-3.jpg')}}" alt="">
                        <div class="team-desc">
